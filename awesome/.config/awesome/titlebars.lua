        ...
        if c.class == "music" or c.name == "Music Terminal" then
            ...
            awful.titlebar(c, {font = beautiful.titlebar_font, position = beautiful.titlebar_position, size = beautiful.titlebar_size}) : setup {
                ...
                { -- Left
                    ...
                    --pad(10),
                    -- Clickable buttons
		    wibox.container.margin(awful.titlebar.widget.closebutton(c),9,0,9,9),
		    wibox.container.margin(awful.titlebar.widget.minimizebutton(c),9,0,9,9),
		    wibox.container.margin(awful.titlebar.widget.maximizedbutton(c),9,0,9,9),
                ...
                { -- Right
                    ...
                    --awful.titlebar.widget.stickybutton   (c),
                    --awful.titlebar.widget.ontopbutton    (c),
		    --wibox.container.margin(awful.titlebar.widget.minimizebutton(c),10,0,10,10),
		    --wibox.container.margin(awful.titlebar.widget.maximizedbutton(c),10,0,10,10),
		    --wibox.container.margin(awful.titlebar.widget.closebutton(c),10,10,10,10),
                    --buttons = buttons,
                    -- In the presence of buttons, use padding to center the title if needed.
                    -- pad(1),
                    layout = titlebar_item_layout
